...
- У вас сама игра уже в некоей стадии релиза, играбельна, читабельна, протестирована и понятна. Делать модуль в какой-то стадии разработки игры это просто трата времени моя и ваша(ваше время будет тратится, ибо я вас задергаю непонятными мне вопросами). 
- Исходя из предложения выше - вы готовы отвечать на вопросы о своей игре. Не получится, что дал книгу и я там что-то делаю, а потом приношу готовый релиз. Будьте готовы, что я буду писать вам много и каждый день во время активной разработки.
