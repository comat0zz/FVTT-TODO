...
- Я не буду делать закрытую ото всех систему для узконаправленной НРИ, в которую играет 2.5 землекопа, или вход только по приглашениям, или сообщество маленькое и не активное.
...
Перед тем как мне написать, что вы хотите свою НРИ видеть в Foundry VTT, соберите следующую информацию:

- Вы ознакомились с Foundry VTT, знаете что это, как он работает(хотя бы с позиции игрока), примерные его возможности, и зачем он вам вообще нужен(ещё список ниже приведу). Если у вас не будет для себя ответа на этот пункт - не тратьте время. 
...
- Надо, потому что бесплатно! ***Поверьте, это очень хорошо видно при общении о проекте***
...
Если вы настроены серьезно именно на платную разработку, я уверен, что есть куча разработчиков под Foundry VTT, кто согласится на ваше предложение(ссылки на ресурсы приложил ниже). Я не отказываюсь на корню, но чек на проект буду выкатывать как веб разработчик выше среднего по рынку, а никак покрутить домашний пет-проект за 300 рублей. Я не ищу подработку, и очень тщательно выбираю проекты.  

- Русскоязычное комьюнити: https://discord.gg/Gumpk3gX
- Мультиязычное комьюнити: https://discord.gg/foundryvtt

## Что сейчас у меня по плану, так сказать очередь наработок и небольшое портфолио
