...
- Вы ознакомились с Foundry VTT, знаете что это, как он работает(хотя бы с позиции игрока), примерные его возможности, и зачем он вам вообще нужен(ещё список ниже приведу). Если у вас не будет для себя ответа на этот пункт - не тратьте время, закрывайте эту страницу, пейте чай. 
